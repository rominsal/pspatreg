...
Using these data, we first estimate fully parametric spatial linear autoregressive panel models using the function `pspatfit()` included in the library `pspatreg` (based on the REML estimator) and compare them with the results obtained using the functions provided by the library `splm` (based on the ML estimator).
...
##  0.2657991 -0.1295384  0.3916562 -0.0367427 
##       cons       serv 
## -0.1668684  0.0121982
```
...
## empgrowth  1.982376e-04 -8.094238e-05 -3.045614e-06
## partrate  -8.094238e-05  5.427641e-04 -7.222182e-05
## agri      -3.045614e-06 -7.222182e-05  7.423076e-04
## cons       3.028110e-05 -1.647323e-04  1.888545e-04
## serv      -6.851324e-06 -7.878910e-05  2.737076e-04
##                    cons          serv
## empgrowth  0.0000302811 -6.851324e-06
## partrate  -0.0001647323 -7.878910e-05
## agri       0.0001888545  2.737076e-04
## cons       0.0019780673  2.429180e-04
## serv       0.0002429180  4.235754e-04
```
...
##            Estimate Std. Error   t value Pr(>|t|)
## empgrowth -0.176463   0.018478 -9.549994   0.0000
## partrate   0.532467   0.032986 16.142322   0.0000
## agri      -0.048966   0.038486 -1.272308   0.2033
## cons      -0.225418   0.059283 -3.802411   0.0001
## serv       0.017136   0.028375  0.603907   0.5459
## 
##  Direct Parametric Impacts (sar) 
##            Estimate Std. Error   t value Pr(>|t|)
## empgrowth -0.132754   0.013656 -9.721209   0.0000
## partrate   0.400544   0.022969 17.438102   0.0000
## agri      -0.036842   0.028928 -1.273575   0.2028
## cons      -0.169581   0.044470 -3.813364   0.0001
## serv       0.012887   0.021329  0.604205   0.5457
## 
##  Indirect Parametric Impacts (sar) 
##             Estimate Std. Error    t value Pr(>|t|)
## empgrowth -0.0437093  0.0058538 -7.4667927   0.0000
## partrate   0.1319230  0.0139878  9.4313196   0.0000
## agri      -0.0121247  0.0096371 -1.2581251   0.2083
## cons      -0.0558376  0.0154306 -3.6186394   0.0003
## serv       0.0042486  0.0070744  0.6005640   0.5481
```
...
## gamsar -3874.8 -3886.1 19.932 7789.4 7927.8 1686.7
##        p.val
## gam         
## gamsar     0
```
...
## gam             -4720.5 -4729.5  17.106 9475.2
## sp3danova_restr -2898.1 -2894.6 231.872 6259.9
##                    BIC LRtest p.val
## gam             9592.5             
## sp3danova_restr 7577.9 3669.8     0
```
...
```
##                  logLik rlogLik    edf    AIC
## sp3danova_restr -2898.1 -2894.6 231.87 6259.9
## sp3danovasarar1 -2655.6 -2654.8 193.82 5698.8
##                    BIC
## sp3danova_restr 7577.9
## sp3danovasarar1 6808.1
```
...
##  Total Parametric Impacts (sar) 
##           Estimate Std. Error   t value Pr(>|t|)
## partrate  0.160776   0.022769  7.061206   0.0000
## agri     -0.023866   0.020887 -1.142637   0.2532
## cons     -0.025792   0.044538 -0.579092   0.5625
## 
##  Direct Parametric Impacts (sar) 
##           Estimate Std. Error   t value Pr(>|t|)
## partrate  0.152916   0.021490  7.115852   0.0000
## agri     -0.022709   0.019882 -1.142224   0.2534
## cons     -0.024539   0.042366 -0.579209   0.5624
## 
##  Indirect Parametric Impacts (sar) 
##            Estimate Std. Error    t value Pr(>|t|)
## partrate  0.0078596  0.0037099  2.1185268   0.0341
## agri     -0.0011565  0.0012027 -0.9615849   0.3363
## cons     -0.0012528  0.0024378 -0.5139299   0.6073
```
