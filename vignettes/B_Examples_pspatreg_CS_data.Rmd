...
<img src="unnamed-chunk-2-2.png" title="plot of chunk unnamed-chunk-2" alt="plot of chunk unnamed-chunk-2" style="display: block; margin: auto;" />
...
## Fitting Model...
## 
##  Time to fit the model:  20.75 seconds
```
...
##  Goodness-of-Fit 
## 
## EDF Total:      7  Sigma: 0.207251
## AIC:       -6438.86 BIC:  -6397.36
```
...
##      0.37914289      3.68695005      0.03265698 
## lnTotal_Bsmt_SF   lnGr_Liv_Area     Garage_Cars 
##      0.05051180      0.39898386      0.11918120 
##      Fireplaces 
##      0.05561747
```
...
<img src="unnamed-chunk-7-2.png" title="plot of chunk unnamed-chunk-7" alt="plot of chunk unnamed-chunk-7" style="display: block; margin: auto;" />
...
## (Intercept)      1.070029e-02 -3.453954e-04   -3.954499e-05
## lnLot_Area      -3.453954e-04  5.579367e-05    3.373658e-07
## lnTotal_Bsmt_SF -3.954499e-05  3.373658e-07    9.301295e-06
## lnGr_Liv_Area   -1.073115e-03 -2.106257e-05   -2.956793e-06
## Garage_Cars      2.102490e-04 -4.424820e-06   -2.170831e-06
## Fireplaces       2.393512e-04 -6.362072e-06   -1.474422e-06
##                 lnGr_Liv_Area   Garage_Cars    Fireplaces
## (Intercept)     -1.073115e-03  2.102490e-04  2.393512e-04
## lnLot_Area      -2.106257e-05 -4.424820e-06 -6.362072e-06
## lnTotal_Bsmt_SF -2.956793e-06 -2.170831e-06 -1.474422e-06
## lnGr_Liv_Area    1.859057e-04 -2.821929e-05 -2.601437e-05
## Garage_Cars     -2.821929e-05  2.908747e-05 -2.951033e-06
## Fireplaces      -2.601437e-05 -2.951033e-06  3.737200e-05
```
...
##                   Estimate Std. Error    t value Pr(>|t|)
## lnLot_Area       0.0520754  0.0120871  4.3083361        0
## lnTotal_Bsmt_SF  0.0815877  0.0050095 16.2867302        0
## lnGr_Liv_Area    0.6419407  0.0248380 25.8451089        0
## Garage_Cars      0.1924615  0.0090925 21.1670037        0
## Fireplaces       0.0900624  0.0095923  9.3890702        0
## 
##  Direct Parametric Impacts (sar) 
##                   Estimate Std. Error    t value Pr(>|t|)
## lnLot_Area       0.0350627  0.0081362  4.3094558        0
## lnTotal_Bsmt_SF  0.0549293  0.0032737 16.7789240        0
## lnGr_Liv_Area    0.4321757  0.0150891 28.6416619        0
## Garage_Cars      0.1295693  0.0056772 22.8228628        0
## Fireplaces       0.0606364  0.0064170  9.4493783        0
## 
##  Indirect Parametric Impacts (sar) 
##                   Estimate Std. Error    t value Pr(>|t|)
## lnLot_Area       0.0170127  0.0039873  4.2666805        0
## lnTotal_Bsmt_SF  0.0266584  0.0019150 13.9210536        0
## lnGr_Liv_Area    0.2097650  0.0115021 18.2370221        0
## Garage_Cars      0.0628922  0.0038820 16.2010763        0
## Fireplaces       0.0294259  0.0032991  8.9194623        0
```
...
## Fitting Model...
## 
##  Time to fit the model:  0 seconds
```
...
##  Goodness-of-Fit 
## 
## EDF Total:     11  Sigma: 0.203923
## AIC:       -6042.92 BIC:  -5977.7
```
...
## Fitting Model...
## 
##  Time to fit the model:  16.57 seconds
```
...
##  Parametric Terms 
##                        Estimate Std. Error t value
## (Intercept)           4.4597496  0.1342379 33.2227
## lnLot_Area            0.0737198  0.0114615  6.4320
## lnTotal_Bsmt_SF       0.0480672  0.0030874 15.5687
## lnGr_Liv_Area         0.4197362  0.0150700 27.8524
## Garage_Cars           0.0976557  0.0060307 16.1931
## Fireplaces            0.0572769  0.0063076  9.0807
## Wlag.lnLot_Area      -0.0555470  0.0126881 -4.3779
## Wlag.lnTotal_Bsmt_SF  0.0077602  0.0040507  1.9158
## Wlag.lnGr_Liv_Area   -0.1116222  0.0184707 -6.0432
## Wlag.Garage_Cars      0.0685589  0.0072130  9.5049
## Wlag.Fireplaces       0.0016591  0.0079522  0.2086
## rho                   0.3707484  0.0143322 25.8682
##                       Pr(>|t|)    
## (Intercept)          < 2.2e-16 ***
## lnLot_Area           1.479e-10 ***
## lnTotal_Bsmt_SF      < 2.2e-16 ***
## lnGr_Liv_Area        < 2.2e-16 ***
## Garage_Cars          < 2.2e-16 ***
## Fireplaces           < 2.2e-16 ***
## Wlag.lnLot_Area      1.243e-05 ***
## Wlag.lnTotal_Bsmt_SF    0.0555 .  
## Wlag.lnGr_Liv_Area   1.714e-09 ***
## Wlag.Garage_Cars     < 2.2e-16 ***
## Wlag.Fireplaces         0.8347    
## rho                  < 2.2e-16 ***
## ---
## Signif. codes:  
## 0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
##  Goodness-of-Fit 
## 
## EDF Total:     12  Sigma: 0.201599
## AIC:       -6555.7 BIC:  -6484.55
```
...
## linslx 3032.5  2978.7  11 -6042.9 -5870.3       
## linsdm 3289.9  3234.7  12 -6555.7 -6374.3 511.93
##              p.val
## linslx            
## linsdm 2.4173e-113
```
...
## Fitting Model...
## 
##  Time to fit the model:  17.47 seconds
```
...
##  Goodness-of-Fit 
## 
## EDF Total:      7  Sigma: 0.234569
## AIC:       -6060.69 BIC:  -6019.19
```
...
## Fitting Model...
## 
##  Time to fit the model:  0.39 seconds
```
...
##  Goodness-of-Fit 
## 
## EDF Total: 43.1458  Sigma: 0.202724
## AIC:       -5829.32 BIC:  -5573.5
```
...
## Fitting Model...
## 
##  Time to fit the model:  32.17 seconds
```
...
##  Goodness-of-Fit 
## 
## EDF Total: 45.1718  Sigma: 0.189564
## AIC:       -6574.85 BIC:  -6307.02
```
...
## gamsar 3332.6  3319.9 45.172 -6574.8 -6282.3 249.39
##             p.val
## linsar           
## gamsar 8.0086e-33
```
...
## Fitting Model...
## 
##  Time to fit the model:  80 seconds
```
...
##  Goodness-of-Fit 
## 
## EDF Total: 92.9601  Sigma: 0.16269
## AIC:       -6876.14 BIC:  -6324.97
```
...
## sp2dsar 3531.0  3524.0 92.960 -6876.1 -6314.0 408.19
##              p.val
## gamsar            
## sp2dsar 1.0661e-58
```
...
## Fitting Model...
## 
##  Time to fit the model:  75.25 seconds
```
...
##  Goodness-of-Fit 
## 
## EDF Total: 94.6793  Sigma: 0.161741
## AIC:       -6862.9 BIC:  -6301.53
```
...
<img src="unnamed-chunk-31-1.png" title="plot of chunk unnamed-chunk-31" alt="plot of chunk unnamed-chunk-31" style="display: block; margin: auto;" /><img src="unnamed-chunk-31-2.png" title="plot of chunk unnamed-chunk-31" alt="plot of chunk unnamed-chunk-31" style="display: block; margin: auto;" /><img src="unnamed-chunk-31-3.png" title="plot of chunk unnamed-chunk-31" alt="plot of chunk unnamed-chunk-31" style="display: block; margin: auto;" />
...
<img src="plot2dpoints_noanova_ames-1.png" title="plot of chunk plot2dpoints_noanova_ames" alt="plot of chunk plot2dpoints_noanova_ames" style="display: block; margin: auto;" />
...
<img src="plot2dpoints_anova_ames-1.png" title="plot of chunk plot2dpoints_anova_ames" alt="plot of chunk plot2dpoints_anova_ames" style="display: block; margin: auto;" /><img src="plot2dpoints_anova_ames-2.png" title="plot of chunk plot2dpoints_anova_ames" alt="plot of chunk plot2dpoints_anova_ames" style="display: block; margin: auto;" /><img src="plot2dpoints_anova_ames-3.png" title="plot of chunk plot2dpoints_anova_ames" alt="plot of chunk plot2dpoints_anova_ames" style="display: block; margin: auto;" /><img src="plot2dpoints_anova_ames-4.png" title="plot of chunk plot2dpoints_anova_ames" alt="plot of chunk plot2dpoints_anova_ames" style="display: block; margin: auto;" />
...
## Fitting Model...
## 
##  Time to fit the model:  97.97 seconds
```
...
##  Goodness-of-Fit 
## 
## EDF Total: 109.285  Sigma: 0.161594
## AIC:       -6813.57 BIC:  -6165.6
```
