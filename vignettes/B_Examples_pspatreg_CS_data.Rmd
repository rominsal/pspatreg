...
## Fitting Model...
## 
##  Time to fit the model:  27.77 seconds
```
...
##                   Estimate Std. Error    t value Pr(>|t|)
## lnLot_Area       0.0530550  0.0121927  4.3513854        0
## lnTotal_Bsmt_SF  0.0815066  0.0051216 15.9142847        0
## lnGr_Liv_Area    0.6425593  0.0242185 26.5317227        0
## Garage_Cars      0.1918820  0.0097374 19.7055849        0
## Fireplaces       0.0891885  0.0104662  8.5215682        0
## 
##  Direct Parametric Impacts (sar) 
##                   Estimate Std. Error    t value Pr(>|t|)
## lnLot_Area       0.0357610  0.0081801  4.3717037        0
## lnTotal_Bsmt_SF  0.0549440  0.0033301 16.4992830        0
## lnGr_Liv_Area    0.4331557  0.0147367 29.3929010        0
## Garage_Cars      0.1293429  0.0060800 21.2733826        0
## Fireplaces       0.0601201  0.0069640  8.6329227        0
## 
##  Indirect Parametric Impacts (sar) 
##                   Estimate Std. Error    t value Pr(>|t|)
## lnLot_Area       0.0172940  0.0040509  4.2691608        0
## lnTotal_Bsmt_SF  0.0265625  0.0019722 13.4683722        0
## lnGr_Liv_Area    0.2094036  0.0114016 18.3661167        0
## Garage_Cars      0.0625392  0.0041184 15.1852346        0
## Fireplaces       0.0290684  0.0036203  8.0292496        0
```
...
## Fitting Model...
## 
##  Time to fit the model:  20.49 seconds
```
...
## Fitting Model...
## 
##  Time to fit the model:  22 seconds
```
...
## Fitting Model...
## 
##  Time to fit the model:  0.25 seconds
```
...
## Fitting Model...
## 
##  Time to fit the model:  30.08 seconds
```
...
## Fitting Model...
## 
##  Time to fit the model:  82.09 seconds
```
...
## Fitting Model...
## 
##  Time to fit the model:  86.29 seconds
```
...
## Fitting Model...
## 
##  Time to fit the model:  95.75 seconds
```
